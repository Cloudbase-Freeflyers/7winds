  ...
  return (
    <section id="safety" className="section bg-brand-soft">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h2 className="mt-3 font-display text-3xl sm:text-4xl font-extrabold text-brand-black">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4 text-start">
          {SAFETY.map((s) => (
            <div
              key={s}
