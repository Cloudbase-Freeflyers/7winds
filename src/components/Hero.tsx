    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-8 py-14 sm:py-18 lg:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          {/* ── Phone mockup ── mobile: below text, desktop: right column */}
          <div className="order-2 shrink-0 w-[190px] sm:w-[210px] lg:w-[220px] mx-auto lg:mx-0">
            ...
            >
              ...
              <a
                href="#video"
                className="group relative block aspect-[9/16] rounded-[2rem] overflow-hidden bg-black"
                aria-label="צפו בסרטון"
              >
                {/* Thumbnail */}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={`https://img.youtube.com/vi/${SHORT_ID}/0.jpg`}
